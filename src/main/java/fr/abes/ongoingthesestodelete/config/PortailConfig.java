package fr.abes.ongoingthesestodelete.config;
...
@EnableJpaRepositories(
        basePackages = "fr.abes.ongoingthesestodelete.portail.repositories",
...
public class PortailConfig
{
    ...
    public DataSource portailDataSource() {
        ...
        config.setPoolName("poolPortailOnGoingToDelete");
        //Infrequently used
    ...
    public LocalContainerEntityManagerFactoryBean portailEntityManagerFactory()
    {
        ...
        factory.setPackagesToScan(new String[]{"fr.abes.ongoingthesestodelete.portail.entities"});
